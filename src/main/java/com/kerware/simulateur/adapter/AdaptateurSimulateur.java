package com.kerware.modelrefac.adapter;

import com.kerware.simulateur.ICalculateurImpot;
import com.kerware.modelrefac.model.SituationFamiliale;
import com.kerware.modelrefac.service.SimulateurService;
...
public final class AdaptateurSimulateur implements ICalculateurImpot {
    ...
    @Override public void setRevenusNetDeclarant1(int rn) { 
        service.setRevenus(rn, service.getRev2()); }
    @Override public void setRevenusNetDeclarant2(int rn) {
         service.setRevenus(service.getRev1(), rn); }
    ...
    @Override public void setNbEnfantsSituationHandicap(int h) { 
        service.setEnfants(service.getNbEnf(), h); }
    ...
    @Override public double getContribExceptionnelle() 
    { return service.getContribExceptionnelle(); }
    ...
    @Override public int getImpotAvantDecote() { return (int)(
        service.getImpBrutFoyer() + service.getDecote() - service.getContribExceptionnelle()); }
